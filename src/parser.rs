    ...
    let app = app
        ...
        .arg(
            Arg::new("post-data")
                ...
                .num_args(1)
                .help_heading("Composite settings")
                .conflicts_with_all(["data"])
                .help("Set -H 'Content-Type: application/x-www-form-urlencoded' and --data to <post-data>"),
        )
        .arg(
            Arg::new("post-form")
                .long("post-form")
                ...
                .help_heading("Composite settings")
                .conflicts_with_all(["data"])
                .help("Set -H 'Content-Type: multipart/form-data; boundary=----WebKitFormBoundaryXXX' and --data to <post-form>"),
        )
        .arg(
            Arg::new("post-json")
                .long("post-json")
                ...
                .help_heading("Composite settings")
                .conflicts_with_all(["data"])
                .help("Set -H 'Content-Type: application/json', and --data to <post-json>"),
        )
        .arg(
            Arg::new("smart")
                .long("smart")
