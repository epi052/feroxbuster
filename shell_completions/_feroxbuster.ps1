...
Register-ArgumentCompleter -Native -CommandName 'feroxbuster' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'feroxbuster' {
            ...
            [CompletionResult]::new('-O', 'O', [CompletionResultType]::ParameterName, 'Formats response logs to --output (--format <csv, json, string>')
            [CompletionResult]::new('--format', 'format', [CompletionResultType]::ParameterName, 'Formats response logs to --output (--format <csv, json, string>')
