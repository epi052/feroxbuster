...
Register-ArgumentCompleter -Native -CommandName 'feroxbuster' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'feroxbuster' {
            ...
            [CompletionResult]::new('--smart', 'smart', [CompletionResultType]::ParameterName, 'Set --auto-tune and --collect-words to true')
            ...
            [CompletionResult]::new('--dont-collect-backups', 'dont-collect-backups', [CompletionResultType]::ParameterName, 'Don''t automatically request likely backup extensions for "found" urls')
