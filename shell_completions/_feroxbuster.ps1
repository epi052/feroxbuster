...
Register-ArgumentCompleter -Native -CommandName 'feroxbuster' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'feroxbuster' {
            ...
            [CompletionResult]::new('--post-form', '--post-form', [CompletionResultType]::ParameterName, 'Set -H ''Content-Type: multipart/form-data; boundary=----WebKitFormBoundaryXXX'' and --data to <post-form>')
