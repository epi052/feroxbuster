...
complete -c feroxbuster -n "__fish_use_subcommand" -s F -l format -d 'Output file\'s format (csv, json, text)' -r -f -a "Csv Json Text"
...
complete -c feroxbuster -n "__fish_use_subcommand" -l json -d 'Emit JSON logs to --output and --debug-log instead of normal text. Consider using (--format json) instead'
