...
set edit:completion:arg-completer[feroxbuster] = {|@words|
    ...
    var completions = [
        &'feroxbuster'= {
            ...
            cand -w 'Path(s) or URL(s) of the wordlist(s); may be supplied multiple times (ex: -w a.txt -w b.txt) or as a comma-separated list (ex: -w a.txt,b.txt). Words from every source are merged and de-duplicated.'
            cand --wordlist 'Path(s) or URL(s) of the wordlist(s); may be supplied multiple times (ex: -w a.txt -w b.txt) or as a comma-separated list (ex: -w a.txt,b.txt). Words from every source are merged and de-duplicated.'
