...
set edit:completion:arg-completer[feroxbuster] = {|@words|
    ...
    var completions = [
        &'feroxbuster'= {
            ...
            cand -e 'Extract links from response body (html, javascript, etc...); make new requests based on findings (default: false)'
            cand --extract-links 'Extract links from response body (html, javascript, etc...); make new requests based on findings (default: false)'
