...
set edit:completion:arg-completer[feroxbuster] = {|@words|
    ...
    var completions = [
        &'feroxbuster'= {
            ...
            cand -B 'Automatically request likely backup extensions for "found" urls (default: true)'
            cand --collect-backups 'Automatically request likely backup extensions for "found" urls (default: true)'
